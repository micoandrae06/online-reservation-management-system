...
<body>
     ...
     <main>
      <center><h6><img src="../assets/img/icon_transparent.png" style="width: 35px;">Tropical Breeze Hotel and Resort</h6></center>
            ...
            <center><h5>Room Lodging Report</h5></center>
            <?php
                        ...
                        if($result->num_rows > 0) {
                          ...
                          while($row = $result->fetch_assoc()) {
                            ...
                            $output.= '<td id="td_name'.$row["_id"].'"><center>'.$row["_transaction_num"].'</center></td>';
                             ...
                             $output.= '<td id="td_name'.$row["_id"].'"><center>'.$row["_room_id"].'</center></td>';
                             $output.= '<td id="td_name'.$row["_id"].'"><center>'.$row["_room_type"].'</center></td>';
                             $output.= '<td id="td_name'.$row["_id"].'"><center>'.$row["_hours"].' hours</center></td>';
                             $output.= '<td id="td_name'.$row["_id"].'"><center>₱'.number_format($row["_rate"],2).'</center></td>';
                             $output.= '<td id="td_name'.$row["_id"].'"><center>'.$row["_extra_person"].'</center></td>';
                             $output.= '<td id="td_name'.$row["_id"].'"><center>'.$row["_extra_bed"].'</center></td>';
                             $output.= '<td id="td_name'.$row["_id"].'"><center>'.$row["_exceeding_hours"].'</center></td>';
