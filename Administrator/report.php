    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link active " href="report.php">Report</a></li>   
          <?php
            if ($user_type=='Administrator') {
      ...
      <div class="" id="room" style="background-color: whitesmoke;padding: 15px 15px 15px 15px; border-radius: 10px;">
        <div class="row" style="margin-bottom: 20px;">
                  <div class="col-sm-3">
                    ...
                    <input type="date" class="form-control" name="" id="date_from_room">
                  </div>
                  <div class="col-sm-3">
                    <label>to:</label>
                    <input type="date" class="form-control" name="" id="date_to_room">
                  </div>

                  <div class="col-sm-3">
                    <a class="btn btn-success" style="color: white;margin-top: 20px; min-width: 250px;" id="btn_generate_room" onclick="fetchReservations();">Generate</a>
                  </div>

                   <div class="col-sm-3">
                    <a class="btn btn-primary" style="color: white;margin-top: 20px; min-width: 250px;" id="btn_print_room" onclick="fetchReservations();printRoomReport();" >Print</a>
                  </div>
                 ...
                 <div class="" id="resort" style="display:none;background-color: whitesmoke;padding: 15px 15px 15px 15px; border-radius: 10px;">
                  ...
                  <div class="col-sm-3">
                    <label>Date |from:</label>
                    <input type="date" class="form-control" name="" id="date_from_resort">
                  </div>
                  <div class="col-sm-3">
                    <label>to:</label>
                    <input type="date" class="form-control" name="" id="date_to_resort">
                  </div>

                  <div class="col-sm-3">
                    <a class="btn btn-success" style="color: white;margin-top: 20px; min-width: 250px;" id="btn_generate_resort" onclick="fetchResortReservations();">Generate</a>
                  </div>

                   <div class="col-sm-3">
                    <a class="btn btn-primary" style="color: white;margin-top: 20px; min-width: 250px;" id="btn_print_resort" onclick="fetchResortReservations();printResortReport();">Print</a>
                  </div>
...
<script type="text/javascript">
  ...
  function fetchReservations(){
    var date_from=document.getElementById("date_from_room").value;
    var date_to=document.getElementById("date_to_room").value;
   ...
   var dataTable1 = $('#tbl_reservations').DataTable({
    ...
    "ajax" : {
     url:"functions/select_room_report.php?"+other_data,
     type:"POST",
     cache:false,
...
function fetchResortReservations(){
    var date_from=document.getElementById("date_from_resort").value;
    var date_to=document.getElementById("date_to_resort").value;
    var other_data="date_from="+date_from+
                   "&date_to="+date_to;
   ...
   var dataTable1 = $('#tbl_reservations_resort').DataTable({
    ...
    "ajax" : {
     url:"functions/select_resort_report.php?"+other_data,
     type:"POST",
     cache:false,
 ...
 function opentab2(){
  ...
  swal({
   ...
   function printRoomReport() {
    ...
    var other_data="date_from="+date_from+
                   "&date_to="+date_to;
       window.open("print_room_report.php?"+other_data, '_blank', 'location=yes,height=1366,width=768,scrollbars=yes,status=yes');
    }

    function printResortReport() {
    var date_from=document.getElementById("date_from_resort").value;
    var date_to=document.getElementById("date_to_resort").value;
    var other_data="date_from="+date_from+
                   "&date_to="+date_to;
       window.open("print_resort_report.php?"+other_data, '_blank', 'location=yes,height=1366,width=768,scrollbars=yes,status=yes');
    }
</script>