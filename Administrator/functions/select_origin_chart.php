...
$data=array();
$query = "SELECT COUNT(_id) AS lodging FROM `tbl_room_lodging` WHERE `_guest_origin` LIKE 'reservation'".$date_filter;
...
$query = "SELECT COUNT(_id) AS lodging FROM `tbl_room_lodging` WHERE `_guest_origin` LIKE 'walk-in'".$date_filter;
	$result= $con_str->query($query);
