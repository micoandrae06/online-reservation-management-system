...
<head>
  ...
  <title>Resort | Administrator</title>
      ...
      <div class="container" style="margin-bottom: 50px;">
        <div class="row">
          <div class="col-sm-4" style="padding: 15px 15px 15px 15px;">
            ...
            <input type="text" class="form-control" placeholder="Resort id / name..." id="resortid" style="margin-bottom: 20px;">
          ...
          <div class="col-sm-8">
            <div class="container" style="background-color: whitesmoke;padding: 15px 15px 15px 15px; border-radius: 10px;">
                    <table class="table table-striped table-bordered" id="tbl_resort">
                      <thead class="">
                          <tr> 
...
<script type="text/javascript">
  ...
  function insertResort(){
    var resortid = document.getElementById("resortid").value.trim();
    ...
    if (resortid =='' || description =='' || image =='') {
       swal({title:"Warning!",text: "Please complete the fields!", type:"error"}); 
       return;
    }

    var other_data = 'resortid='+resortid+
                     '&description='+description+
                     '&image_name='+new Date().getTime();

     swal({
                    title: "Continue?",
                    text: "Do you want to save this resort?",
                    type: "question",
       ...
       $.ajax({
                    ...
                    url:"functions/insert_resort.php?"+other_data, 
                    type:"POST",  
                    data:fd,
                    contentType:false,
                    cache:false,
                    ...
                    success:function(data){   
                        if (data.includes('200')) { 
                            ...
                            clearFields();
                            fetchResort();
                            swal({title:"Success!",text: "New resort has been saved.", type:"success"}).then(okay => {
                                    if (okay) {
...
function updateResort(){
    ...
    var other_data = 'resortid='+resortid+
     ...
     swal({
                    title: "Continue?",
                    text: "Do you want to update this resort?",
                    type: "question",
                    showCancelButton: true,
                    confirmButtonColor: "#5cb85c",
                    cancelButtonColor: "#d9534f",
       ...
       $.ajax({
                    ...
                    url:"functions/update_resort.php?"+other_data, 
                    type:"POST",  
                    data:fd,
                    contentType:false,
                    cache:false,
                    ...
                    success:function(data){   
                        if (data.includes('200')) { 
                            ...
                            clearFields();
                            fetchResort();
                            swal({title:"Success!",text: "Resort information has been successfully updated.", type:"success"}).then(okay => {
                                    if (okay) {
...
function clearFields(){
  ...
  document.getElementById("image_add").src="../assets/img/no-img.png";
  document.getElementById("resortid").disabled=false;
  commandStr = 'insert';
}
...
$(document).on("click", "#btn_edit", function() {
  ...
  document.getElementById("resortid").value = $(this).data('resortid');
  document.getElementById("description").value = $(this).data('description');
  document.getElementById("image_add").src="../img-resort/"+$(this).data('img');
  document.getElementById("resortid").disabled=true;
  commandStr='update';
});

function fetchResort(){
    $('#tbl_resort').DataTable().destroy();
  
   var dataTable1 = $('#tbl_resort').DataTable({
    ...
    "ajax" : {
     url:"functions/select_resort.php",
     type:"POST",
     cache:false,
...
$(document).on("click", "#btn_delete", function() {
    ...
    var other_data = 'id='+id;
     ...
     swal({
                    title: "Continue?",
                    text: "Do you want to delete this resort?",
                    type: "question",
                    showCancelButton: true,
                    confirmButtonColor: "#5cb85c",
                    cancelButtonColor: "#d9534f",
       ...
       $.ajax({
                    ...
                    url:"functions/delete_resort.php?"+other_data, 
                    type:"POST",  
                    contentType:false,
                    cache:false,
                    processData:false,
                    ...
                    success:function(data){   
                        ...
                        if (data.includes('200')) { 
                            ...
                            swal({title:"Success!",text: "Resort has been deleted.", type:"success"}).then(okay => {
                                    if (okay) {
                                          fetchResort();             
                                  }
                                    });
