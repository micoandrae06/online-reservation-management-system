...
<head>
  ...
  <title>Reservation Success | Tropical Breeze</title>
...
<script type="text/javascript">
  ...
  function insertReservation(){
    ...
    $.ajax({
             ...
             url:"functions/validate_resort_reservation.php?"+other_data, 
             type:"POST",  
             contentType:false,
             cache:false,
             processData:false,
             ...
             success:function(data){   
                   ...
                   if (data.includes('200')) {
                      swal({title:"Success!",text: "Your reservation has been successfully confirmed.", type:"success"}).then(okay => {
                                    if (okay) {
